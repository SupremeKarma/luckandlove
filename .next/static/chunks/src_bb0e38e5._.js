...
function ProductsPage() {
                ...
                "ProductsPage.useEffect.fetchProducts": async ()=>{
                    ...
                    if (error) {
                        ...
                        const productsData = data.map({
                            "ProductsPage.useEffect.fetchProducts.productsData": (p)=>({
                                    ...p,
                                    imageUrl: p.image_url
                                })
                        }["ProductsPage.useEffect.fetchProducts.productsData"]);
    ...
    const pageTitle = searchTerm ? 'Search Results for "'.concat(searchTerm, '"') : selectedSubcategory ? "".concat(selectedSubcategory) : selectedCategory ? selectedCategory : 'All Products';
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProductsPage, "0M5s4vdhF4QzrjGCRwZ5tWhUlc0=", false, function() {
    return [
...
//# sourceMappingURL=src_bb0e38e5._.js.map